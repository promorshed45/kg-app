...
const Program = () => {
    return (
        <div>
            <section class="text-gray-700 body-font bg-gradient-to-r from-muted  to-muted-foreground">
                <div class="px-24 py-24 mx-auto">
                    <motion.div
                        ...
                        <h1 class="md:text-5xl text-2xl font-semibold title-font mb-4 text-primary"> Our Programs </h1>
