        ...
        <div className="flex flex-col md:flex-row">
            <div className="w-1/2 flex-grow relative">
                ...
                <section className="z-0 text-gray-700 body-font h-lvh relative flex justify-center items-center">
                    <div className="absolute inset-0 bg-gradient-to-r from-secondary-foreground/40 to-primary-foreground/40 opacity-80"></div>
            ...
            <div className="flex  w-1/2 bg-gradient-to-r from-purple-400 to-rose-400 ">
                <div className="flex flex-col w-full">
                    <h2 className="text-4xl font-semibold text-white sm:text-5xl p-5 md:p-10 text-center"> Parents Says  </h2>
